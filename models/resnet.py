...
class ResNet(nn.Module):
    ...
    def __init__(self, nc,block, layers, num_classes=1000, zero_init_residual=False,
        ...
        if replace_stride_with_dilation is None:
            ...
            # the 2x2 stride with a dilated convolution instead 扩张卷积
        ...
        self.conv1 = nn.Conv2d(self.nc, self.inplanes, kernel_size=7, stride=self.strides[0], padding=3,
                               bias=False)
...
def resnet18(nc,pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet('resnet18',nc, BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
